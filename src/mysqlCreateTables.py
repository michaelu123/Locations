...
class MySqlCreateTables:
    ...
    def initDB(self, app):
        ...
        fields = ["creator VARCHAR(40)", "created DATETIME", "modified DATETIME", "lat DOUBLE", "lon DOUBLE", "lat_round VARCHAR(20)",
                  "lon_round VARCHAR(20)"]
        for feld in self.baseJS.get("daten").get("felder"):
            name = feld.get("name")
            colnames.append(name)
            type = sqtype[feld.get("type")]
            fields.append(name + " " + type)
        fields.append("PRIMARY KEY (lat_round, lon_round)")
        ...
        fields = ["creator VARCHAR(40)", "created DATETIME", "lat DOUBLE", "lon DOUBLE", "lat_round VARCHAR(20)",
                  "lon_round VARCHAR(20)",
        ...
        fields = ["nr INTEGER PRIMARY KEY", "creator VARCHAR(40)", "created DATETIME", "modified DATETIME",
                  "lat DOUBLE", "lon DOUBLE", "lat_round VARCHAR(20)", "lon_round VARCHAR(20)"]
